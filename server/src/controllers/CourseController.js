...
const { create, deleted, update, getAll, pagination } = require('../model/Course');
...
module.exports = { apiCreateCourse, apiDeleteCourse, apiUpdateCourse, apiGetCourse, apiCoursePagination };
